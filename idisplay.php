            ...
            <tbody>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            <button class="btn btn-success"><a href="iupdate.php?updateid=' . $instructor_id . '" class="text-light">Update</a></button>
                            <button class="btn btn-danger"><a href="idelete.php?deleteid=' . $instructor_id . '" class="text-light">Delete</a></button>
                        </td>
                        </tr>';
                    }
                } else {
